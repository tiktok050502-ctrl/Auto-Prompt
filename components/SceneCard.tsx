...
const SceneCard: React.FC<SceneCardProps> = ({ scene }) => {
    ...
    const handleCopyWishk = () => {
         navigator.clipboard.writeText(scene.wishk_prompt).then(() => {
            ...
            setTimeout(() => setIsWishkCopied(false), 2000); // Reset after 2 seconds
        });
    }

    return (
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 hover:border-indigo-300 hover:shadow-2xl hover:-translate-y-1">
            <div className="p-6 md:p-8 bg-gradient-to-r from-gray-50 to-white border-b border-gray-100">
                ...
                <div className="space-y-6">
                    <div>
                        <div className="flex justify-between items-center mb-3">
                            <h4 className="font-bold text-gray-800 text-lg">Chi tiết Kịch bản</h4>
                            <button
                        ...
                        <div className="text-gray-700 text-sm bg-gray-50 p-4 rounded-2xl border border-gray-200 whitespace-pre-wrap leading-relaxed shadow-inner hover:bg-white hover:shadow-sm transition-all">
                    ...
                    <div>
                        ...
                        <pre className="text-sm text-indigo-800 bg-indigo-50/50 p-4 rounded-2xl border border-indigo-100 whitespace-pre-wrap font-mono text-xs mb-4 shadow-inner hover:bg-indigo-50 transition-colors">
                    ...
                    {scene.wishk_prompt && (
                        <div>
                            ...
                            <div className="text-sm text-amber-900 bg-amber-50 p-4 rounded-2xl border border-amber-200/60 whitespace-pre-wrap font-medium shadow-inner hover:bg-amber-100/50 transition-colors">
                                {scene.wishk_prompt}
                            </div>
                        </div>
                    )}
